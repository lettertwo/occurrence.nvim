...
describe("Location", function()
  describe(".new", function()
    ...
    it("clamps line or to valid integer range", function()
      assert.equal(Location.new(-1, 0), Location.new(0, 0))
      assert.equal(Location.new(0, -1), Location.new(0, 0))
      assert.equal(Location.new(math.huge, 0), Location.new(vim.v.maxcol - 1, 0))
      assert.equal(Location.new(0, math.huge), Location.new(0, vim.v.maxcol - 1))
    end)
  end)
